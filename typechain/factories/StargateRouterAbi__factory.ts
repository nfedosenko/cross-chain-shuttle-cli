...
import type {
  StargateRouterAbi,
  StargateRouterAbiInterface,
} from "../StargateRouterAbi";
...
export class StargateRouterAbi__factory {
  static readonly abi = _abi;
  static createInterface(): StargateRouterAbiInterface {
    return new utils.Interface(_abi) as StargateRouterAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StargateRouterAbi {
    return new Contract(address, _abi, signerOrProvider) as StargateRouterAbi;
  }
}
